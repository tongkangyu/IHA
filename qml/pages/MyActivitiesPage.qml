...
Rectangle {
    ...
    readonly property var activeChallenges: {
        var arr = []
        for (var i = 0; i < dataList.length; i++)
            if (dataList[i].status === "ACTIVE") arr.push(dataList[i])
        return arr
    }
    readonly property var completedChallenges: {
        var arr = []
        for (var i = 0; i < dataList.length; i++)
    ...
    Component.onCompleted: {
        ...
        xhr.open("GET", (typeof apiBaseUrl !== 'undefined' ? apiBaseUrl : "http://localhost:8080/api") + "/challenges")
        ...
        Flickable {
            ...
            Column {
                ...
                Rectangle {
                    ...
                    Row {
                        ...
                        Column {
                            spacing: 4
                            anchors.verticalCenter: parent.verticalCenter
                            Text { text: completedChallenges.length.toString(); font.pixelSize: 24; font.weight: Font.Bold; color: successColor }
                        ...
                        Column {
                            spacing: 4
                            anchors.verticalCenter: parent.verticalCenter
                            Text { text: activeChallenges.length.toString(); font.pixelSize: 24; font.weight: Font.Bold; color: warningColor }
                ...
                Column {
                    ...
                    Repeater {
                        model: activeChallenges
                        
                        Rectangle {
                            width: activitiesPage.width - 32
                            height: 140
                            radius: 16
                            color: cardColor
                            anchors.horizontalCenter: parent.horizontalCenter
                            ...
                            Column {
                                ...
                                Row {
                                    ...
                                    Column {
                                        ...
                                        Text { text: "剩余" + modelData.days_remaining + "天"; font.pixelSize: 13; color: warningColor }
                                    }
                                }
                                ...
                                Text {
                                    text: "已完成 " + modelData.progress + "/" + modelData.target
                                    font.pixelSize: 13
                                    color: textSecondary
                                }
                            }
                        ...
                        Rectangle {
                            ...
                            Row {
                                ...
                                Column {
                                    ...
                                    Text { text: modelData.description; font.pixelSize: 13; color: textSecondary }
                                }
                            }
                        }
                    }
